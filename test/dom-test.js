    ...
    while(steps++<60000){
      ...
      if(!rejected&&steps===400){
        ...
        if(a0){
          ...
          Cw.sendHost({k:'act',a:{t:'PASS',seat:other}});           // not the prompted seat
          Cw.sendHost({k:'act',a:{t:'GIVE',from:other,to:a0.seat}});// not the prompted seat
          Cw.sendHost({k:'act',a:{t:'PICK'}});                      // pick during exchange / vice versa
